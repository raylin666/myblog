...
<form class="friend_submit">
	...
	<div class="input">
		...
		<input type="email" placeholder="请输入您的联系邮箱号<?= Helper::options()->JFriendEmail == 'on' ? '，审核通过后会邮箱通知您' : null ?>" name="email">
	</div>
	<?php
...
<script type="text/javascript">
	document.querySelector('.friend_submit').addEventListener('submit', (event) => {
